...
import { sessionHandler, tokenRefreshHandler, type SessionHandler, type Session_Locals } from './auth.middleware.js';
...
export const googleCallback: [
  OICD_TokenHandler,
  RequestHandler<object, object, object, object, OICD_Token_Locals & Session_Locals>,
  SessionHandler,
  SessionHandler
] = [
